  ...
  public void execute() {
    ...
    */
    ...
    if((RobotContainer.Xbox1.getLeftX() == 0 && RobotContainer.Xbox1.getLeftY() == 0 && RobotContainer.Xbox1.getRightX() == 0)){
      ...
      drivetrain.rotateModuleNonLinear(SwerveModule.FRONT_LEFT, Math.atan2(B, D)*(180/Math.PI), 0.5);
      drivetrain.rotateModuleNonLinear(SwerveModule.FRONT_RIGHT, Math.atan2(B, C)*(180/Math.PI), 0.5);
      drivetrain.rotateModuleNonLinear(SwerveModule.REAR_LEFT, Math.atan2(A, D)*(180/Math.PI), 0.5);
